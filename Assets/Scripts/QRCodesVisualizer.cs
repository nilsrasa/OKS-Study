            ...
            lock (pendingActions)
            {
                while (pendingActions.Count > 0)
                {
                    ...
                    if (action.type == ActionData.Type.Added)
                    {
                        ...
                        //GameObject oks = Instantiate(oksPrefab, new Vector3(0, 0, 0), Quaternion.identity);
                        //oks.GetComponent<OKSlines>().target = qrCodeObject.transform;
                    }
